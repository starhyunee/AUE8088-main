...
if __name__ == "__main__":
    ...
    parser.add_argument('--annFile', type=str, default='utils/eval/KAIST_val-A_annotation.json',
                        help='Please put the path of the annotation file. Only support json format.')
    parser.add_argument('--rstFiles', type=str, nargs='+', default=['runs/train/yolov5l_advance-rgbt3/epoch3_predictions_fixed.json',
                                                                    'runs/train/yolov5l_advance-rgbt3/epoch9_predictions_fixed.json',
                                                                    'runs/train/yolov5l_advance-rgbt3/epoch14_predictions_fixed.json',
                                                                    'runs/train/yolov5l_advance-rgbt3/epoch19_predictions_fixed.json'],
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='eval models')
    parser.add_argument('--annFile', type=str, default='KAIST_val-A_annotation.json',
                        help='Please put the path of the annotation file. Only support json format.')
