...
def parse_opt():
    ...
    parser.add_argument("--textListFile",   type=str, default='datasets/kaist-rgbt/val_split.txt',         help="Text file containing image file names (e.g., train-all-04.txt)")
    parser.add_argument("--xmlAnnDir",      type=str, default='datasets/kaist-rgbt/train/labels-xml',   help="XML annotation directory")
    parser.add_argument("--jsonAnnFile",    type=str, default='utils/eval/KAIST_val-A_annotation.json',           help="Output json filename")
